#!/bin/sh
wlr-randr --output DP-1 --mode 1920x1080@359.747986Hz --pos 0,0 --adaptive-sync enabled
# wlr-randr --output DP-1 --mode 1920x1080@359.747986Hz --pos 1080,420 --adaptive-sync enabled
